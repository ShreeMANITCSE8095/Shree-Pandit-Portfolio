...
import heroVideo from '../assets/hero video/shree-hero.mp4';
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="hidden lg:flex flex-col gap-6 fixed left-6 top-1/2 -translate-y-1/2 z-50 mix-blend-difference">
        ...
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            <path d="M18.244 2H21l-6.52 7.47L22 22h-6.828l-5.34-6.57L4.07 22H1.31l7.02-8.05L2 2h6.97l4.87 6.01L18.244 2zm-1.19 17.56h1.53L7.87 3.49H6.23l10.824 16.07z" />
          </svg>
        </a>
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer" 
          className="text-white/60 hover:text-[#ff6b00] transition-all duration-300 transform hover:scale-125"
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            ...
            <a href={socialLinks.x} target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white" aria-label="X">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2H21l-6.52 7.47L22 22h-6.828l-5.34-6.57L4.07 22H1.31l7.02-8.05L2 2h6.97l4.87 6.01L18.244 2zm-1.19 17.56h1.53L7.87 3.49H6.23l10.824 16.07z" /></svg>
            </a>
            <a href={socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-[#ff6b00]" aria-label="Instagram">
        ...
        <div 
          ...
          onClick={toggleVideo}
        >
          <div className="w-12 h-12 md:w-20 md:h-20 rounded-full border border-white/30 bg-black/20 backdrop-blur-md flex justify-center items-center group-hover:scale-110 group-hover:bg-[#ff6b00] transition-all duration-500 shadow-[0_0_30px_rgba(255,255,255,0.1)] group-hover:shadow-[0_0_40px_rgba(255,107,0,0.6)]">
            {!isPlaying || isMuted ? (
              // Play Icon
