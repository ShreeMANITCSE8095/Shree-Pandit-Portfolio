...
const ExperienceCard = ({ item, index }) => (
  ...
  >
    <div>
      ...
      <p className="text-orange-200 text-sm font-black tracking-wide mb-4 uppercase">
        {item.organization}
      </p>
      {item.summary ? (
      ...
      <div className="mb-6">
        <h4 className="text-white/60 text-xs font-bold uppercase tracking-wider mb-2">Points:</h4>
...
const Experience = () => {
  return (
    <section id="experience" className="bg-[#ff6b00] pt-24 pb-32 px-6 md:px-12 w-full relative overflow-hidden font-sans">
